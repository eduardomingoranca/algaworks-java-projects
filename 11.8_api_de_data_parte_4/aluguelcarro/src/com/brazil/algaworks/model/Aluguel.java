...
public class Aluguel {
    ...
    public void imprimeFatura() {
        ...
        if (!duration.isNegative()) {
            double multa = duration.toHours() * getCarro().getValorDiaria() * 0.1;
            System.out.println("Valor da multa: R$ " + multa + ". Pois voce atrasou " + duration.toHours() + " dias.");
        } else System.out.println("Obrigado. Voce foi pontual.");
    }
